...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'djangocontact1@gmail.com'
EMAIL_HOST_PASSWORD = 'A01120010320'
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
DEFAULT_FROM_EMAIL = 'djangocontact1@gmail.com'
SERVER_EMAIL = 'djangocontact1@gmail.com'
...
# all static collected by django saved here - STATIC_ROOT
# STATIC_ROOT = os.path.join(BASE_DIR, 'dist')
STATIC_ROOT = os.path.join(BASE_DIR, 'static')

# the url used to refer static files saved in STATIC_ROOT
STATIC_URL = '/static/'

# addtional places to search for static files
STATICFILES_DIRS = (
